import{_ as l,r,o as i,a as o,b as n,f as c,F as t,e as s,d as a}from"./app.c99367b6.js";var p="/datascience/anaconda-boltons.png",d="/datascience/anaconda-boltons-channel.png";const u={},b=s(`<h1 id="anaconda-comandos-avanzados" tabindex="-1"><a class="header-anchor" href="#anaconda-comandos-avanzados" aria-hidden="true">#</a> Anaconda: Comandos Avanzados</h1><ul><li>Creamos un ambiente virtual (py39)</li></ul><div class="language-bash ext-sh line-numbers-mode"><pre class="language-bash"><code>conda create --name py39 <span class="token assign-left variable">python</span><span class="token operator">=</span><span class="token number">3.9</span> <span class="token assign-left variable">pandas</span><span class="token operator">=</span><span class="token number">1.2</span>
