...
export { Author, AuthorInfo, BasePageFrontMatter, BaseThemeConfig, ConvertLocaleConfig, DateDetail, DateInfo, DateOptions, HopeLang, Logger, addViteOptimizeDepsExclude, addViteOptimizeDepsInclude, addViteSsrExternal, addViteSsrNoExternal, capitalize, checkLang, compareDate, deepAssign, deepAssignReverse, encodeCDATA, encodeXML, getAuthor, getCategory, getDate, getLocalePaths, getLocales, getRootLang, getRootLangPath, getTag, injectLocalizedDate, isAbsoluteUrl, isUrl, lang2Path, mergeViteConfig, noopModule, path2Lang, removeGitPlugin, showLangError, strictCapitalize, timeTransformer, useCustomDevServer, useGitPlugin };
