...
interface PageSeoInfo<ExtendObject = Record<string, unknown>> {
    app: App;
...
interface SeoOptions {
     ...
     * 自定义 OGP 生成器
     */
    ogp?: <ExtendObject = Record<string, unknown>>(ogp: SeoContent, info: PageSeoInfo<ExtendObject>) => SeoContent;
    /**
     * Custom JSON-LD Generator
     *
     * 自定义 JSON-LD 生成器
     */
    jsonLd?: <ExtendObject = Record<string, unknown>>(jsonLD: ArticleJSONLD | null, info: PageSeoInfo<ExtendObject>) => ArticleJSONLD | null;
    /**
     * Custom head tags
     *
     * 自定义 Head 标签
     */
    customHead?: <ExtendObject = Record<string, unknown>>(head: HeadConfig[], info: PageSeoInfo<ExtendObject>) => void;
}

declare const seoPlugin: Plugin<SeoOptions>;
declare const seo: (options: SeoOptions | false) => PluginConfig<SeoOptions>;

export { ArticleJSONLD, ArticleSeoContent, BaseSeoContent, ExtendPage, ExtendedSeoContent, FacebookSeoContent, PageSeoInfo, SeoContent, SeoOptions, SimpleSeoContent, TwitterSeoContent, seoPlugin as default, seo, seoPlugin };
