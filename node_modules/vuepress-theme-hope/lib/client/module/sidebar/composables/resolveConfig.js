...
export const resolveMultiSidebarItems = (sidebarConfig, headingDepth) => {
    ...
    for (const base of keys) {
        if (route.path.startsWith(base))
            return resolveArraySidebarItems(sidebarConfig[base] ?? [], headingDepth, base);
    }
...
export const resolveSidebarItems = () => {
    ...
    const headingDepth = frontmatter.value.headingDepth ?? themeLocale.value.headingDepth ?? 2;
