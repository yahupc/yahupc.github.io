...
<h3 id="cambiar-la-el-tamano-de-una-columna" tabindex="-1"><a class="header-anchor" href="#cambiar-la-el-tamano-de-una-columna" aria-hidden="true">#</a> Cambiar la el tamaño de una columna</h3>
<div class="language-mysql ext-mysql line-numbers-mode"><pre v-pre class="language-mysql"><code>ALTER TABLE name_table MODIFY name_column VARCHAR(30);
